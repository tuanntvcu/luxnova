...
function luxnova_register_post_types(): void {
	...
	register_post_type(
		...
		array(
			'labels' => array(
				'name' => esc_html__( 'Đánh giá khách hàng', 'luxnova' ),
				'singular_name' => esc_html__( 'Đánh giá', 'luxnova' ),
				'menu_name' => esc_html__( 'Đánh giá khách hàng', 'luxnova' ),
				'add_new' => esc_html__( 'Thêm đánh giá', 'luxnova' ),
				'add_new_item' => esc_html__( 'Thêm đánh giá khách hàng', 'luxnova' ),
				'edit_item' => esc_html__( 'Sửa đánh giá khách hàng', 'luxnova' ),
				'new_item' => esc_html__( 'Đánh giá mới', 'luxnova' ),
				'view_item' => esc_html__( 'Xem đánh giá', 'luxnova' ),
				'search_items' => esc_html__( 'Tìm đánh giá', 'luxnova' ),
				'not_found' => esc_html__( 'Chưa có đánh giá nào', 'luxnova' ),
				'not_found_in_trash' => esc_html__( 'Không có đánh giá nào trong thùng rác', 'luxnova' ),
			),
			'public' => true,
